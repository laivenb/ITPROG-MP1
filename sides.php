  ...
  <br><br>
    ...
    <section class="menu-items">
      <article class="menu-item">
        <img src="assets/images/fruit_cocktail.jpg" alt="Fruit Cocktail"> <br>
        <p>Fruit Cocktail</p>
        <p>&#8369;180</p>
      </article>
      <article class="menu-item">
        <img src="assets/images/mashed_potato.jpg" alt="Mashed Potato"><br>
        <p>Mashed Potato</p>
        <p>&#8369;150</p>
      </article>
      <article class="menu-item">
        <img src="assets/images/mac_n_cheese.jpg" alt="Mac n' Cheese"><br>
        <p>Mac n' Cheese</p>
        <p>&#8369;175</p>
      </article>
    </section>
